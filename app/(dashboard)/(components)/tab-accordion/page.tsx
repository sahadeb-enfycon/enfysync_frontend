...
const metadata: Metadata = {
  title: "Tabs & Accordion Components | enfySync Admin Dashboard",
  description:
    "Explore interactive tabs and accordion components for organized content display in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
