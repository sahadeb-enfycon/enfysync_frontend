...
const metadata: Metadata = {
  title: "Tooltips & Hover Information | enfySync Admin Dashboard",
  description:
    "Enhance user experience with customizable tooltips and hover-based information displays in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
