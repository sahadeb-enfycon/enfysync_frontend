...
const metadata: Metadata = {
  title: "Pagination Controls & Navigation | enfySync Admin Dashboard",
  description:
    "Implement and customize pagination controls for seamless data navigation in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
