...
const metadata: Metadata = {
  title: "User Avatars & Profile Images | enfySync Admin Dashboard",
  description:
    "Manage and display user avatars, profile images, and avatar customization options in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
