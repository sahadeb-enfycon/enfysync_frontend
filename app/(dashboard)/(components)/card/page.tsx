...
const metadata: Metadata = {
  title: "Cards & Content Containers | enfySync Admin Dashboard",
  description:
    "Showcase versatile card components and content containers for organized layout in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
