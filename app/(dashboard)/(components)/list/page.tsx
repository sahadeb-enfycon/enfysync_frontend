...
const metadata: Metadata = {
  title: "User List & Management | enfySync Admin Dashboard",
  description:
    "View, manage, and organize users with the user list and management features in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
