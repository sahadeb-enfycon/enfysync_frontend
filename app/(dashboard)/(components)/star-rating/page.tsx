...
const metadata: Metadata = {
  title: "Star Ratings & Review Components | enfySync Admin Dashboard",
  description:
    "Display and customize star rating components for user reviews and feedback in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
