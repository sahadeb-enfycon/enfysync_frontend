...
const metadata: Metadata = {
  title: "Dropdowns & Menu Navigation | enfySync Admin Dashboard",
  description:
    "Manage and customize dropdown menus and navigation components in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
