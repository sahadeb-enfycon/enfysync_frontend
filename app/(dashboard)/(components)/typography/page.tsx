...
const metadata: Metadata = {
  title: "Typography & Text Styles | enfySync Admin Dashboard",
  description:
    "Explore typography settings, font styles, and text utilities for consistent design in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
