...
const metadata: Metadata = {
  title: "Badges & Status Indicators | enfySync Admin Dashboard",
  description:
    "Explore customizable badges, status indicators, and notification labels in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
