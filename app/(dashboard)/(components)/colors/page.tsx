...
const metadata: Metadata = {
  title: "Colors & Theme Palette | enfySync Admin Dashboard",
  description:
    "Explore the color schemes, theme palettes, and customizable color utilities in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
