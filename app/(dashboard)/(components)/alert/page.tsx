...
const metadata: Metadata = {
  title: "Alert Notifications & Messages | enfySync Admin Dashboard",
  description:
    "Manage and customize alert notifications, messages, and user prompts with the enfySync Admin Dashboard template built using Next.js and Tailwind CSS.",
};
