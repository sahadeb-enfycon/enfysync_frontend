...
const metadata: Metadata = {
  title: "Switches & Toggle Controls | enfySync Admin Dashboard",
  description:
    "Manage and customize switch and toggle controls for interactive settings in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
