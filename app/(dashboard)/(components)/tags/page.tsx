...
const metadata: Metadata = {
  title: "Tags & Label Elements | enfySync Admin Dashboard",
  description:
    "Manage and display tag components and label elements for categorization and UI organization in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
