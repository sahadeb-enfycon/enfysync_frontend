...
const metadata: Metadata = {
  title: "Buttons & Interactive Controls | enfySync Admin Dashboard",
  description:
    "Discover various button styles, sizes, and interactive controls in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
