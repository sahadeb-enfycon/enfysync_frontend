...
const firebaseFields = [
    ...
    { id: 'firebaseAuthDomain', label: 'Firebase AUTH Domain', value: 'enfySync.firebaseapp.com' },
    { id: 'firebaseProjectID', label: 'Firebase Project ID', value: 'enfySync.com' },
    { id: 'firebaseStorageBucket', label: 'Firebase Storage Bucket', value: 'enfySync.appsport.com' },
