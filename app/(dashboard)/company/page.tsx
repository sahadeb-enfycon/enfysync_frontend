...
const metadata: Metadata = {
    title: "Company Profile & Details | enfySync Admin Dashboard",
    description:
        "View and manage company profiles, business details, and related information in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
