...
const metadata: Metadata = {
    title: "Email Details & Message View | enfySync Admin Dashboard",
    description:
        "View detailed email content, sender information, and message actions in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
