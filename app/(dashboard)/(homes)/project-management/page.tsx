...
const metadata: Metadata = {
    title: "Project Management | Track Tasks, Teams & Productivity - enfySync Admin Panel",
    description:
        "Manage projects, assign tasks, monitor team performance, and track productivity effortlessly with the Project Management Dashboard in enfySync Admin Template. Built using Next.js, Tailwind CSS, and ShadCN UI for a smooth and modern workflow experience.",
};
