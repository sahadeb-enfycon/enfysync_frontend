...
const metadata: Metadata = {
  title: "Investment Dashboard | enfySync Admin Panel",
  description:
    "Track investment portfolios, returns, and market insights in the Investment Dashboard of enfySync Admin Template built with Next.js and Tailwind.",
};
