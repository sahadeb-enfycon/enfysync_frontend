...
const metadata: Metadata = {
    title: "Call Center Dashboard | Manage Calls, Agents & Performance - enfySync Admin Panel",
    description: "Monitor call activities, manage agents, track customer queries, and analyze performance with the Call Center Dashboard in enfySync. Built using Next.js, Tailwind CSS, and ShadCN UI for a fast, modern, and efficient workflow experience.",
};
