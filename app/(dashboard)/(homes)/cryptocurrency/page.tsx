...
const metadata: Metadata = {
  title: "Cryptocurrency Dashboard | enfySync Admin Panel",
  description:
    "Track real-time crypto prices, wallet balances, and market trends with the Cryptocurrency Dashboard in enfySync Admin Template.",
};
