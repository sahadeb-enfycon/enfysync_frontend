...
const metadata: Metadata = {
    title: "Medical Dashboard | enfySync Admin Panel",
    description:
        "Monitor patient data, manage appointments, and analyze healthcare metrics with the Medical Dashboard in enfySync Admin Template built using Next.js, Tailwind, and Shadcn UI.",
};
