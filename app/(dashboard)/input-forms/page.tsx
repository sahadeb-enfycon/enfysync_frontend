...
const metadata: Metadata = {
    title: "Input Forms & Field Elements | enfySync Admin Dashboard",
    description:
        "Design and manage input forms, fields, and form elements for data collection in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
