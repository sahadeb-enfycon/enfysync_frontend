...
const metadata: Metadata = {
    title: "Widgets & Dashboard Components | enfySync Admin Dashboard",
    description:
        "Explore customizable widgets and dashboard components to display key information in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
