...
const metadata: Metadata = {
    title: "Input Layouts & Form Structure | enfySync Admin Dashboard",
    description:
        "Organize and customize input layouts and form structures for optimal user experience in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
