...
const metadata: Metadata = {
  title: "Forgot Password & Account Recovery | enfySync Admin Dashboard",
  description:
    "Recover your account by resetting your password in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
