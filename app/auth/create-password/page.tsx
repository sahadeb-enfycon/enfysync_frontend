...
const metadata: Metadata = {
  title: "Create Password & Account Security | enfySync Admin Dashboard",
  description:
    "Set up and manage secure passwords for your account in the enfySync Admin Dashboard built with Next.js and Tailwind CSS.",
};
